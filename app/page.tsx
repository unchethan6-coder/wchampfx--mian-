  ...
  return (
    <>
      ...
      <main id="top">
        ...
        <section className="section-sm"><div className="container roadmap-wrap center"><span className="eyebrow">Roadmap Preview</span><h2>Inside The $1M Funding Roadmap</h2><div className="roadmap">{roadmap.map((item, index) => <div className="road-step" key={item}><div className="step-dot">{index + 1}</div><span>{item}</span></div>)}</div><button className="btn" onClick={openModal}>Get My Free Roadmap</button></div></section>
        ...
        <section className="section" id="dan"><div className="container authority"><div className="dan-visual"><div className="portrait-mark">DC</div><div className="dan-copy"><span className="micro">THE PERSON BEHIND THE PROCESS</span><strong>Dan Cheung</strong><span className="muted">Trader, coach and founder of WChampFX.</span></div></div><div><span className="eyebrow">Built from experience</span><h2>Structure beats noise.</h2><p className="lead">Dan built WChampFX for traders who want a repeatable path through the prop funding journey — not another collection of disconnected strategies.</p><div className="stat-list"><div className="stat"><b>$500K+</b><span>verified payouts*</span></div><div className="stat"><b>347+</b><span>students inside WChampFX</span></div><div className="stat"><b>1 process</b><span>from strategy to scale</span></div><div className="stat"><b>100%</b><span>free roadmap access</span></div></div><button className="btn" onClick={openModal}>Get the framework</button></div></div></section>
        ...
        <section className="section-sm"><div className="container final"><div><span className="eyebrow">Your roadmap is free</span><h2>Stop guessing what to fix next.</h2><p className="lead">Get the WChampFX $1M Prop Funding Roadmap and see the full process in one place.</p></div><button className="btn" onClick={openModal}>GET THE FREE ROADMAP →</button></div></section>
      </main>
